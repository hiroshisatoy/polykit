...
function gd_build_sticky_header() {
	...
	let gd_header_is_sticky = 'true' === localStorage.getItem( 'polykit_header_is_sticky' );
	...
	toggle_sticky_input.addEventListener( 'click', ( e ) => {
		...
		localStorage.setItem( 'polykit_header_is_sticky', ( ( true === gd_header_is_sticky ) ? 'true' : 'false' ) );
		e.stopPropagation();
	} );
