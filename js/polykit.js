...
const polykit_extension_storage =
  (null !== localStorage.getItem("polykit_extension_status"))
    ? JSON.parse(localStorage.getItem("polykit_extension_status"))
    : "";
const polykit_extension = {
  changelog: ("" !== polykit_extension_storage)
    ? polykit_extension_storage.changelog
    : "",
  currentVersion: ("" !== polykit_extension_storage)
    ? polykit_extension_storage.currentVersion
    : "0",
  previousVersion: ("" !== polykit_extension_storage)
    ? polykit_extension_storage.previousVersion
    : "0",
  reason: ("" !== polykit_extension_storage)
    ? polykit_extension_storage.reason
    : "",
};
const polykit_has_been_updated =
  polykit_extension.currentVersion !== polykit_extension.previousVersion;
