...
!function (e, t) {
	...
	return function e() {
		...
		if (
			n.version = "2.3.5", n.removed = [], !t || !t.document || 9 !== t.document.nodeType
		...
		var fe = {};
		n.isSupported = "function" == typeof te && ae &&
			void 0 !== ae.createHTMLDocument && 9 !== me;
		var de = H,
			pe = U,
			he = z,
			ge = B,
			...
			it = function (e) {
				nt && nt === e ||
					(e && "object" === (void 0 === e ? "undefined" : W(e)) || (e = {}),
						...
						e.FORBID_CONTENTS &&
						(je === Pe && (je = x(je)), E(je, e.FORBID_CONTENTS)),
						Ue && (Te["#text"] = !0),
		...
		var ut = function (e) {
			...
			ht = function (e) {
				return e instanceof V &&
					("string" != typeof e.nodeName || "string" != typeof e.textContent ||
			...
			vt = function (e) {
				...
				if (
					yt("uponSanitizeElement", e, { tagName: r, allowedTags: Te }),
						...
						T(/<[/\w]/g, e.innerHTML) && T(/<[/\w]/g, e.textContent)
				) return mt(e), !0;
				if ("select" === r && T(/<template/i, e.innerHTML)) return mt(e), !0;
				if (!Te[r] || ke[r]) {
					if (Ue && !je[r]) {
						var o = te(e) || e.parentNode, i = ee(e) || e.childNodes;
						if (i && o) {
							for (var a = i.length - 1; a >= 0; --a) {
								o.insertBefore(J(i[a], !0), Q(e));
							}
						}
					}
					if (!ke[r] && Tt(r)) {
						if (xe.tagNameCheck instanceof RegExp && T(xe.tagNameCheck, r)) {
							return !1;
						}
				...
				return e instanceof s && !ut(e) ? (mt(e), !0) : "noscript" !== r && "noembed" !== r ||
						!T(/<\/no(script|embed)/i, e.innerHTML)
					? (De && 3 === e.nodeType &&
						(t = e.textContent,
							t = y(t, de, " "),
							t = y(t, pe, " "),
							e.textContent !== t &&
							(p(n.removed, { element: e.cloneNode() }), e.textContent = t)),
						yt("afterSanitizeElements", e, null),
						!1)
					: (mt(e), !0);
			},
			bt = function (e, t, n) {
				if (He && ("id" === t || "name" === t) && (n in o || n in rt)) {
					return !1;
				}
				if (_e && !Se[t] && T(he, t));
				else if (we && T(ge, t));
					...
					"src" !== t && "xlink:href" !== t && "href" !== t || "script" === e ||
					0 !== v(n, "data:") || !Ge[e]
				) {
					if (Oe && !T(ye, y(n, ve, "")));
					else if (n) return !1;
		...
		return n.sanitize = function (e, o) {
			...
			if (!n.isSupported) {
				if (
					"object" === W(t.toStaticHTML) || "function" == typeof t.toStaticHTML
				) {
			...
			if (
				Ce || it(o), n.removed = [], "string" == typeof e && (ze = !1), ze
			) {
				if (e.nodeName) {
					var f = tt(e.nodeName);
					if (!Te[f] || ke[f]) {
				...
				1 ===
								(l = (i = dt("\x3c!----\x3e")).ownerDocument.importNode(e, !0))
									.nodeType && "BODY" === l.nodeName || "HTML" === l.nodeName
					? i = l
					: i.appendChild(l);
			} else {
				if (!Re && !De && !Me && -1 === e.indexOf("<")) {
					return re && Fe ? re.createHTML(e) : e;
				}
				if (!(i = dt(e))) return Re ? null : Fe ? oe : "";
			}
			i && Le && mt(i.firstChild);
			for (var d = pt(ze ? e : i); s = d.nextNode();) {
				3 === s.nodeType && s === u || vt(s) ||
					(s.content instanceof a && At(s.content), Nt(s), u = s);
			}
			if (u = null, ze) return e;
			if (Re) {
				if (Ie) {
					for (m = ce.call(i.ownerDocument); i.firstChild;) {
						m.appendChild(i.firstChild);
					}
				} else m = i;
				return Ae.shadowroot && (m = ue.call(r, m, !0)), m;
			}
			var p = Me ? i.outerHTML : i.innerHTML;
			return De && (p = y(p, de, " "), p = y(p, pe, " ")), re && Fe ? re.createHTML(p) : p;
		},
